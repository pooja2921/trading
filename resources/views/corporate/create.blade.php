...
@section('content')
    ...
    <div class="container-fluid">
            ...
            <div class="row align-items-end fixheader">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('Add Corporates')}}</h5>
                            <span>{{ __('Create new Corporates')}}</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <form class="forms-sample" method="POST" action="{{ route('corporate.store') }}" enctype= multipart/form-data id="corporateform">
        @csrf
        @include('include.message')
                        ...
                        <div class="card-body">
                            ...
                            @endif
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="email">GST Type</label>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card ">
                        <div class="card-header">
                            <strong><h3>{{ __('Shiiping Address')}}</h3></strong>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6">
