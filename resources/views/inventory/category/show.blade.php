  ...
  @endpush
            ...
            <div class="row align-items-end fixheader">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ isset($parentname->name) ? $parentname->name:'' }} @if(isset($parentname)) > @endif {{ isset($parentcategory->name) ? $parentcategory->name:'' }} {{ __('Product Category')}}</h5>
                            <span>View, delete and update Product Category</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header row">
                        ...
                        <div class="col col-sm-5">
                            <div class="card-search with-adv-search dropdown">
                                <form action="{{route('categories.search')}}" method="get">
                                    <input type="text" class="form-control global_filter searchclass" id="search" name="name" placeholder="Search.." >
                        ...
                        <div class="col col-sm-5">
                            <div class="card-options text-right">
                                {{--<span class="mr-5" id="top">{{($selectcategory->currentpage()-1)*$selectcategory->perpage()+1}} to {{$selectcategory->currentpage()*$selectcategory->perpage()}}
                                            of  {{$selectcategory->total()}} entries</span>--}}
                    ...
                    <div class="card-header"><h3> {{ isset($parentcategory->name) ? $parentcategory->name:'' }} {{ __('Product Category')}}</h3></div>
                    <div class="card-body">
                                ...
                                @foreach($selectcategory as $cat)
                                  <tr>
                                    <td>
                                      ...
                                      <td>
                                        <a href="{{ route('showchild', $cat['id']) }}"><i class="ik ik-list"></i></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div class="modal-dialog w-300" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="categoryAddLabel">{{ __('Add Product Category')}}</h5>
                  ...
                  <div class="modal-body">
                    <span id="publicurl" data-value="{{url('/')}}"></span>
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" name="name" class="form-control" placeholder="Enter Product Category">
                      </div>
    ...
    <div class="modal fade edit-layout-modal pr-0 " id="categoryView" tabindex="-1" role="dialog" aria-labelledby="categoryViewLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog w-300" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="categoryViewLabel">{{ __('Edit Product Category')}}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                  ...
                  <div class="modal-body">
                    <span id="publicurl" data-value="{{url('/')}}"></span>
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" name="name" class="form-control catname" placeholder="Enter Product Category" value="">
                      </div>
            ...
            <div class="modal-content">
                ...
                <form class="forms-sample" method="GET" action="{{ route('subcategory') }}" enctype= multipart/form-data >
                  <div class="modal-body">
                    ...
                    <span id="deleteurl"  data-dlturl="{{url('category/deleteimg')}}" ></span>
                      <div class="form-group">
                          <input  type="hidden" class="form-control catid" name="id" >
